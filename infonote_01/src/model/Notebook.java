...
public class Notebook {
	...
	public String toString() {
		return "Notebook [numeroNote=" + numeroNote + ", modelo=" + modelo + ", descricao=" + descricao + ", estoque="
				+ estoque + ", precoUrbano=" + precoUrbano + ", figura=" + figura + ", dataCadastro=" + dataCadastro
				+ ", getNumeroNote()=" + getNumeroNote() + ", getModelo()=" + getModelo() + ", getDescricao()="
				+ getDescricao() + ", getEstoque()=" + getEstoque() + ", getPrecoUrbano()=" + getPrecoUrbano()
				+ ", getFigura()=" + getFigura() + ", getDataCadastro()=" + getDataCadastro() + ", getClass()="
				+ getClass() + ", hashCode()=" + hashCode() + ", toString()=" + super.toString() + "]";
	}

	public double precoUrbano;
	...
	public double getPrecoUrbano() {
		return precoUrbano;
	}

	public void setPrecoUrbano(double precoUrbano) {
		this.precoUrbano = precoUrbano;
	}
